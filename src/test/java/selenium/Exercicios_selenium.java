...
public class Exercicios_selenium {
    ...
    public void testeFromularioSelenium() throws InterruptedException {
        ...
        // Assert.assertFalse("Elemento não selecionado",driver.findElement(By.xpath("//*[@ng-model='radiovalue' and @value='FeMale']")).isSelected());
        // validar se não está criando um teste fake, msg será retornada no erro.

        driver.findElement(By.xpath("//input[@value='Movies']")).click(); //seleciona um checkbox
        Assert.assertTrue("Chekbox não selecionado",driver.findElement(By.xpath("//input[@value='Movies']")).isSelected());
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//div[contains(text(), 'Portuguese') and @class='ui-autocomple-multiselect-item")).isDisplayed());
        Assert.assertTrue(driver.findElement(By.xpath("//div[contains(text(), 'English') and @class='ui-autocomple-multiselect-item")).isDisplayed());
    }
